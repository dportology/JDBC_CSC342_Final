...
public class PersonDAO {
    ...
    public void createPerson(Person person) throws SQLException
    {
		...
		try
        {
            ...
            ps=con.prepareStatement("insert into Team3.person (Person_id, First_name, Last_name, Street_address, city, state, postal_code," +
...
public BigDecimal findMaxPersonId() throws SQLException
{
    ...
    try
    {
    	...
    	con = DBConnect.getConnection();
    	ps=con.prepareStatement("select max(p.person_id) from Team3.Person p");
...
public Person viewPerson(BigDecimal personId) throws SQLException
	...
	public void updatePerson(Person empl) throws SQLException
    {
        ...
        try
        {
        	...
        	ps=con.prepareStatement("update Team3.person set p.first_name = ?, p.last_name = ?, " +
	...
	public void deletePerson(BigDecimal personId) throws SQLException
    {
        ...
        try
        {
        	...
        	con = DBConnect.getConnection();
            ps=con.prepareStatement("delete Team3.person where person_id=?");
            ps.setBigDecimal(1,personId);
            ps.executeQuery();
    	...
    	public void countPeople() throws SQLException
        {
        	...
        	PreparedStatement ps= null;
        	ResultSet rs = null;
        	String sql1 = "Select count(*) from Team3.Person p inner join Team3.customer c " + 
    	...
    	public void savePeople(List<Person> people) throws SQLException
        {
        	...
        	String sql1 = "Select count(*) as person_count from Team3.Person p WHERE p.person_id = ?";
        	PreparedStatement ps = null;
        	ResultSet rs = null;
